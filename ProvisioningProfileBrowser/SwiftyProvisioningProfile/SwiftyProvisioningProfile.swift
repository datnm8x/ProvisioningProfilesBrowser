...
public extension SwiftyModule.ProvisioningProfile {
  ...
  static func parse(from data: Data) throws -> SwiftyModule.ProvisioningProfile {
    ...
    return try PropertyListDecoder().decode(SwiftyModule.ProvisioningProfile.self, from: data)
  }
}
